...
public class CentroBD extends GenericoBD
{
    ...
    public static ArrayList visualizarListaNombreCentrosTrabajador() 
    {
        abrirConexion();
        ...
        try
        {
            ...
            while(rs.next())
            {
                ...
                trabajadores=TrabajadorBD.listaidTrabajadores(c);
    ...
    public static void insertarCentro(Centro c)
    {
        ...
        try
        {
        String plantilla = "INSERT INTO CENTROS (NOMBRE, CALLE, NUMERO, CP, CIUDAD, PROVINCIA, TELEFONO)"
                + " VALUES (?,?,?,?,?,?,?)";
    ...
    public static void modificar(Centro c) 
    {
        ...
        String plantilla = "UPDATE CENTROS SET NOMBRE='"+c.getNombre()+"',CALLE='"+c.getCalle()
                +"',NUMERO="+c.getNumero()+",CP='"+c.getCp()+"', CIUDAD='"+c.getCiudad()
                +"',PROVINCIA='"+c.getProvincia()+"',TELEFONO='"+c.getTelefono()+"'"
                + " WHERE nombre = '"+ nombre+"'";
        try
        {
        PreparedStatement ps=conn.prepareStatement(plantilla);
    ...
    public static void borrarCentro(Centro c)
    {
        ...
        try
        {
        String plantilla = "DELETE FROM CENTROS WHERE nombre='" + nombre+"'";
        PreparedStatement ps = conn.prepareStatement(plantilla);
        ps.executeUpdate();
        conn.commit();
        }
